...
"background-color: qlineargradient(spread:pad, x1:0.46, y1:0.0343636, x2:0.4595, y2:0.835, stop:0 rgba(0, 223, 185, 255), stop:1 rgba(255, 255, 255, 255));")
        ...
        self.lblClialta.setGeometry(QtCore.QRect(280, 70, 81, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.editClialta.setGeometry(QtCore.QRect(370, 70, 81, 20))
        self.editClialta.setObjectName("editClialta")
        self.btnCalendar = QtWidgets.QPushButton(self.centralwidget)
        self.btnCalendar.setGeometry(QtCore.QRect(460, 60, 41, 41))
        ...
        self.btnCalendar.setIconSize(QtCore.QSize(36, 36))
